...
oc delete -f authentication-backend-enable-mtls.yml -n ${USERID}
oc delete -f authentication-frontend-enable-mtls.yml -n ${USERID}
oc delete -f destination-rule-backend-circuit-breaker-with-pool-ejection.yml -n ${USERID}
oc delete -f destination-rule-backend-v1-v2-mtls.yml -n ${USERID}
oc delete -f destination-rule-backend-v1-v2.yml -n ${USERID}
oc delete -f destination-rule-frontend-mtls.yml -n ${USERID}
oc delete -f destination-rule-frontend-v1-v2.mtls.yml -n ${USERID}
oc delete -f destination-rule-frontend-v1-v2.yml -n ${USERID}
oc delete -f destination-rule-frontend.yml -n ${USERID}
oc delete -f egress-serviceentry.yml -n ${USERID}
oc delete -f frontend-gateway.yml -n ${USERID}
oc delete -f frontend-jwt-authentication.yml -n ${USERID}
oc delete -f frontend-rate-limits.yml -n ${USERID}
oc delete -f log.yml -n ${USERID}
oc delete -f virtual-service-backend-v1-v2-50-50-3s-timeout.yml -n ${USERID}
oc delete -f virtual-service-backend-v1-v2-50-50.yml -n ${USERID}
oc delete -f virtual-service-backend-v1-v2-80-20.yml -n ${USERID}
oc delete -f virtual-service-backend-v1-v2-mirror-to-v3.yml -n ${USERID}
oc delete -f virtual-service-backend.yml -n ${USERID}
oc delete -f virtual-service-frontend-fault-inject.yml -n ${USERID}
oc delete -f virtual-service-frontend-header-foo-bar-to-v1.yml -n ${USERID}
oc delete -f virtual-service-frontend.yml -n ${USERID}
...
oc delete -f istio-files/log.yml -n ${USERID}
